...
* `flex create <service_name>`
    ...
    * `--runtime <node6|node8|node10>`
        ...
        Specifies major Node.js version to run the project on. The minor and patch versions will vary depending on the [latest Flex Runtime updates](#flex-runtime-version-selection). Defaults to `node10`.
