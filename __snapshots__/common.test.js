...
Commands:
  ...
  kinvey app push <file> [app]     Update an application
  ...
  kinvey app export <file> [app]   Export the specified app or the active one
...
Commands:
  ...
  kinvey org show                 Show detailed info for a specified org or for
                                  the active one
  kinvey org use <org>            Set the active organization
  kinvey org export <file> [org]  Export the specified org or the active one
