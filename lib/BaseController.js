...
class BaseController {
  ...
  getActiveOrSpecifiedIdentifier(activeItemName, optionName, cmdOptions) {
    const active = this.cliManager.getActiveItem(activeItemName);
    const wanted = cmdOptions[optionName] || (active && active.id);
    return wanted;
  }
