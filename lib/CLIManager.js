...
class CLIManager {
  ...
  _registerControllers() {
    ...
    this._controllers[Namespace.ENV] = new EnvironmentsController({ cliManager: this, environmentsService, applicationsService, collectionsService, businessLogicService, rolesService, groupsService });
    ...
    this._configFileProcessor = new ConfigFileProcessor({ envFileProcessor });
  }
