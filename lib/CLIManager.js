...
class CLIManager {
  ...
  _registerControllers() {
    ...
    this._configFileProcessor = new ConfigFileProcessor({
      cliManager: this,
  ...
  processConfigFile(operationType, options, done) {
    this._configFileProcessor.process(operationType, options, done);
  }
}
