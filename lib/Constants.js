...
Constants.Errors = {
  ...
  DeploymentVersionTooLow: {
    ...
    MESSAGE: 'The specified service version is lower than the one deployed last. Please bump the version in package.json and try again.'
  },
  InvalidEmail: {
    NAME: 'InvalidEmail',
...
Constants.Mapping[Constants.EntityType.APP] = {
  BASIC: {
    ...
    environments: (item) => {
      return item && item.environments ? item.environments.length : 0;
    }
  }
};
