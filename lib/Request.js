...
const { getDeviceInformation, isConnectionError, isEmpty, isNullOrUndefined } = require('./Utils');
...
class Request {
  ...
  _buildHeaders(user, options) {
    ...
    this.options.headers['X-Kinvey-Device-Information'] = getDeviceInformation(options.cliVersion);
