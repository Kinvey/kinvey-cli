...
constants.EnvironmentVariables = {
  ...
  PROFILE: `${this.PREFIX}PROFILE`,
  HOST: `${this.PREFIX}HOST`
};

constants.AllCommandsNotRequiringAuth = ['init', 'profile create', 'profile list', 'profile show', 'profile delete', 'flex delete'];
...
constants.FlexProjectUploadTimeout = 30 * 1000;
