...
const EnvFileExporterV1 = require('../exporter/EnvFileExporterV1');
    ...
    async.waterfall([
      (next) => {
        this.environmentsService.getActiveOrSpecified(options, (err, data) => {
          ...
          const envFileExporter = new EnvFileExporterV1(this.options, exportOptions);
          envFileExporter.export(next);
        });
      },
      (exportedConfig, next) => {
