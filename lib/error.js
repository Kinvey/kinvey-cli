 ...
 * @param {String|Object} nameOrObject The name of the error or an object containing name and message.
 * @param {String} [message]
 * @constructor
 */
function KinveyError(nameOrObject = 'GeneralError', message) {
  let errorName;
  ...
  this.name = errorName;
  this.message = message || nameOrObject.message;
