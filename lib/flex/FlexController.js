...
const { APIRuntimeToCLIRuntime, AppOptionsName, CLIRuntimeToAPIRuntime, Command, CommonOptionsNames, DeploymentStatus, Errors, EntityType, DomainTypes, InfoMessages, LogErrorMessages, LogLevel,
...
const { Endpoints, formatList, generateSecretKey, getCommandNameFromOptions, getCustomNotFoundError,
    ...
    async.series([
      ...
      (next) => {
        ...
        const deployOpts = {
          ...
          dir,
          schemaVersion,
          runtime: CLIRuntimeToAPIRuntime[options[FlexOptionsNames.RUNTIME]],
