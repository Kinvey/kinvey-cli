...
const { DomainTypes, EntityType, Errors, FlexOptionsNames, HTTPMethod, InfoMessages, LogErrorMessages, LogLevel, PromptMessages, PromptTypes, ServiceStatus, DeploymentStatus } = require('../Constants');
...
class FlexService extends BaseService {
  ...
  deployProject(dir, serviceId, pkgVersion, schemaVersion, uploadTimeout, maxUploadSize, artifacts, envVars, done) {
