...
const { Endpoints, formatList, findAndSortInternalServices, getCustomNotFoundError, isArtifact,
  isEmpty, isNullOrUndefined, isValidNonZeroInteger, isValidTimestamp, readJSON } = require('../Utils');
...
class FlexService extends BaseService {
  ...
  deployProject(dir, serviceId, svcEnvId, pkgVersion, schemaVersion, uploadTimeout, maxUploadSize, artifacts, envVars, runtime, done) {
