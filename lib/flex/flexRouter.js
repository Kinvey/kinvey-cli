...
const { AppOptions, AppOptionsName, CommandRequirement, CommonOptions, CommonOptionsNames, FlexOptions, FlexOptionsNames,
  Namespace, OrgOptions, OrgOptionsName, ServiceOptions, ServiceOptionsNames, SubCommand } = require('../Constants');
  ...
  },
  {
    ...
    builder: (commandsManager) => {
      commandsManager
        ...
        .option('svcEnv', { global: false, describe: 'Service environment name', type: 'string' })
  ...
  },
  {
    ...
    builder: (commandsManager) => {
      commandsManager
        ...
        .option(ServiceOptionsNames.SVC_ENV, ServiceOptions[ServiceOptionsNames.SVC_ENV]);
    },
    handlerName: 'deploy',
    requirements: [CommandRequirement.AUTH]
  },
