...
const prompt = require('./prompt.coffee');
const util = require('./util.coffee');

// todo convert es6 class > module.exports
class Project {
  constructor(path) {
    this.app = null;
    this.org = null;
    ...
    this._selectAppOrOrg = (this._selectAppOrOrg).bind(this);
    this._selectApp = (this._selectApp).bind(this);
    this._execKinveyServices = (this._execKinveyServices).bind(this);
  ...
  _selectService(cb) {
    return async.waterfall([
      this._execKinveyServices, (services, next) => {
