  ...
  serviceStatus(cb) {
    return this._execServiceStatus((err, response) => {
      ...
      if (response.body.version != null) {
        ...
        logger.warn('\'kinvey status\' now supports displaying service version in addition to service health. Please initiate a one-time recycle to enable this feature. See the README or contact Kinvey support for more information.');
      }
