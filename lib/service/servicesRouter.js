...
const { AppOptions, AppOptionsName, CommandRequirement, Namespace, OrgOptions, OrgOptionsName } = require('./../Constants');
...
const cmdDefinitions = [
  ...
  {
    command: `push <serviceId> <file>`,
    desc: 'Update a service',
    builder: (commandsManager) => {
      commandsManager
        .positional('serviceId', { describe: 'Service ID' })
        .positional('file', { describe: 'Path to a service configuration file' });
    },
    handlerName: 'update',
    requirements: [CommandRequirement.AUTH]
