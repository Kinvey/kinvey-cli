...
const utils = {};
utils.formatHost = function(host) {
...
utils.Endpoints = {
  ...
  // `/v${project.schemaVersion}/data-links/${project.service}/status`

  // `/v${this.schemaVersion}/${resourceType}/${entity}/data-links`
};

utils.test = function (smth) {
  console.log(`UTILS TEST ${smth}`);
};
...
utils.isArtifact = function(artifacts, base, filepath) {
